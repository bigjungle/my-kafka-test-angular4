...
@Component({
    selector: 'jhi-department-sdm-suffix',
    templateUrl: './department-sdm-suffix.component.html'
})
export class DepartmentSdmSuffixComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: DepartmentSdmSuffix) {
        return item.id;
    }
