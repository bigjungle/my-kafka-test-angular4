...
@Component({
    selector: 'jhi-person-sdm-suffix',
    templateUrl: './person-sdm-suffix.component.html'
})
export class PersonSdmSuffixComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: PersonSdmSuffix) {
        return item.id;
    }
